...
function PaletteAndTypeStory(): ReactElement {
  return (
    <ThemeRoot
      ...
      data-testid="foundation-story"
    >
      <header className="lagrange-story__header">
        <div>
          <p className="lagrange-story__kicker">
            Lagrange foundation · specimen 01
          </p>
          <Heading level={1} variant="display">
            생활 회계 관찰 기록
          </Heading>
        </div>
        <div className="lagrange-story__meta">
          Aged paper / precise data / compact rhythm
        </div>
      </header>
        ...
        <div className="lagrange-story__swatches">
          {PALETTE.map((color) => (
            ...
            >
              ...
              <span className="lagrange-story__swatch-value">
                {color.value}
              </span>
            </div>
          ))}
      ...
      >
        ...
        <div className="lagrange-story__type-specimens">
          <Stack gap="md" className="lagrange-story__type-column">
            ...
            <Text as="p" tone="muted">
              일상의 수입과 지출을 작은 단위로 관찰하고, 숫자 사이의 관계를
              또렷하게 남깁니다.
            </Text>
          </Stack>
        ...
        <div style={TOKEN_GROUP_GRID_STYLE}>
          <TokenList label="Font family" values={primitiveTokens.fontFamily} />
...
const TOKEN_LAYERS = [
  {
    ...
    responsibility:
      'Raw palette, type, spacing, dimension, radius, border scale',
    groups: Object.keys(primitiveTokens),
  },
  {
    name: 'semanticTokens',
    responsibility:
      'Application-wide roles such as surface, content and status',
    ...
    >
      ...
      <div className="lagrange-story__section lagrange-story__rule-list">
        ...
        <Inline gap="lg" align="stretch">
          ...
          <Text as="p">
            Double rules mark a change in information structure, not a
            decorative emphasis.
          </Text>
        </Inline>
      </div>
